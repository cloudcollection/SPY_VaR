...
DOWNLOADS = Path(__file__).resolve().parents[1] / "outputs"
XELATEX_FALLBACK = Path(__file__).resolve().parents[1] / "tools" / "xelatex.exe"
...
def find_xelatex() -> str:
    ...
    raise FileNotFoundError("xelatex was not found on PATH and the TeX Live fallback path does not exist.")
